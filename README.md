...
Following this, Karpenter has been installed, to manage workload on the cluster. you can find the commands to install karpenter and also insall the NodePool resource on the cluster in the `karpenter/install.sh` file.
